...
IPAddress ip(150, 162, 63, 156); // Endereço IP que a Ethernet Shield terá. Deve ser alterado para um endereço livre da sua rede.
        ...
        while (client.connected()) {
            if (client.available()) {   // os dados do cliente estão disponiveis para serem lidos
                ...
                if (c == '\n' && currentLineIsBlank) {
                    ...
                    client.println("<html>");
                    client.println("<head>");
                    client.println("<title>Dados de Luminosidade</title>");
                    client.println("</head>");
                    client.println("<body>");
